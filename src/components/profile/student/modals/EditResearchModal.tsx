...
export default function EditResearchModal({ onClose }: EditResearchModalProps) {
    const [researchList, setResearchList] = useState<Research[]>([
        {
            id: 1,
            title: "Optimizing Large Language Models for Low-Resource Languages",
            publishedIn: "International Journal of Computer Science (IJCS)",
            publicationDate: "2023-11",
            abstract: "This paper explores parameter-efficient tuning techniques to improve the performance of transformer-based models on Bengali and other low-resource South Asian languages..."
        }
    ]);
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 pt-2">
                                ...
                                <button 
                                    ...
                                    disabled={!newTitle.trim() || !newPublishedIn.trim()}
                                >
