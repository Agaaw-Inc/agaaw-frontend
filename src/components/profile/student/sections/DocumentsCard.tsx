...
interface DocumentsCardProps {
    // We could pass an array of docs here later
}

const docs = [
    { id: 1, title: "Academic Transcript", subtitle: "Last updated: Jan 05, 2024", status: "Uploaded", required: true },
    { id: 2, title: "Student ID Card", subtitle: "Front & back scan", status: "Uploaded", required: true },
    { id: 3, title: "Recommendation Letter", subtitle: "From Department Head", status: "Not Uploaded", required: true },
    { id: 4, title: "English Proficiency Certificate", subtitle: "IELTS / Duolingo / TOEFL", status: "Uploaded", required: true },
    { id: 5, title: "CV / Resume", subtitle: "Professional/Academic CV", status: "Uploaded", required: false },
    { id: 6, title: "Statement of Purpose (SOP)", subtitle: "Draft or final version", status: "Not Uploaded", required: false },
];

export default function DocumentsCard({}: DocumentsCardProps) {
    return (
