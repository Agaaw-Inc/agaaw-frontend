...
export default function MentorDocumentsCard({ documents, onUploadClick, onDelete }: MentorDocumentsCardProps) {
    const docTypes = [
        { type: "certificate", title: "Student ID Card", subtitle: "Front & back scan of current student ID", required: true },
        { type: "transcript", title: "Passport", subtitle: "Information page passport copy", required: true },
        { type: "other", title: "Visa", subtitle: "Valid student visa copy", required: true },
    ];
